...
lyr_temp_0.setVisible(true);lyr_Gangnam_1m_1.setVisible(true);
var layersList = [lyr_temp_0,lyr_Gangnam_1m_1];
lyr_temp_0.set('fieldAliases', {'idx': 'idx', 'RX': 'RX', 'RY': 'RY', 'TX': 'TX', 'TY': 'TY', 'TZ': 'TZ', 'azimuth': 'azimuth', 'tilts': 'tilts', 'chai1': 'chai1', 'chai2': 'chai2', 'dist': 'dist', 'predict': 'predict', 'pre2': 'pre2', 'wb1': 'wb1', 'wb2': 'wb2', 'wb3': 'wb3', 'hj1': 'hj1', 'hj2': 'hj2', });
lyr_Gangnam_1m_1.set('fieldAliases', {'AGL': 'AGL', 'AMSL': 'AMSL', 'PRIORITY': 'PRIORITY', 'CLUTTER': 'CLUTTER', 'IDENTICAL': 'IDENTICAL', 'UNIQUE_ID': 'UNIQUE_ID', 'EDITREASON': 'EDITREASON', 'EDITYYMM': 'EDITYYMM', 'TFID': 'TFID', 'region': 'region', 'APT_CHK': 'APT_CHK', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_temp_0.set('fieldImages', {'idx': 'Range', 'RX': 'Range', 'RY': 'Range', 'TX': 'TextEdit', 'TY': 'TextEdit', 'TZ': 'Range', 'azimuth': 'Range', 'tilts': 'Range', 'chai1': 'TextEdit', 'chai2': 'TextEdit', 'dist': 'TextEdit', 'predict': 'TextEdit', 'pre2': 'TextEdit', 'wb1': 'TextEdit', 'wb2': 'TextEdit', 'wb3': 'TextEdit', 'hj1': 'TextEdit', 'hj2': 'TextEdit', });
lyr_Gangnam_1m_1.set('fieldImages', {'AGL': '', 'AMSL': '', 'PRIORITY': '', 'CLUTTER': '', 'IDENTICAL': '', 'UNIQUE_ID': '', 'EDITREASON': '', 'EDITYYMM': '', 'TFID': '', 'region': '', 'APT_CHK': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_temp_0.set('fieldLabels', {'idx': 'no label', 'RX': 'no label', 'RY': 'no label', 'TX': 'no label', 'TY': 'no label', 'TZ': 'no label', 'azimuth': 'no label', 'tilts': 'no label', 'chai1': 'no label', 'chai2': 'no label', 'dist': 'no label', 'predict': 'no label', 'pre2': 'no label', 'wb1': 'no label', 'wb2': 'no label', 'wb3': 'no label', 'hj1': 'no label', 'hj2': 'no label', });
lyr_Gangnam_1m_1.set('fieldLabels', {'AGL': 'no label', 'AMSL': 'no label', 'PRIORITY': 'no label', 'CLUTTER': 'no label', 'IDENTICAL': 'no label', 'UNIQUE_ID': 'no label', 'EDITREASON': 'no label', 'EDITYYMM': 'no label', 'TFID': 'no label', 'region': 'no label', 'APT_CHK': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
